    ...
    <Page>
      <div className="content">
        ...
        <div>
          ...
          <p className="answer">
            Yes! You can find lecture videos and materials on our <a href="/resources">Resources</a> page.
          </p><p className="question">
            How can I stay in touch with the development of the program?
          </p>
          <p className="answer">
            Even if you aren’t part of the cohort, we’d love to keep you up-to-date on the program evolution, resources from our lectures, etc. The best way to do this is by <a href="https://accessp2p.typeform.com/to/J4ahyX">signing up</a> for our updates, referencing our <a href="/resources">Resources</a> page, or <a href="https://twitter.com/accessp2p">following us</a> on Twitter.
          </p><p className="question">
        ...
        <div>
          ...
          <p className="answer">
          Yes we do! You can find it <a href="/code">here</a>.
          </p>
        </div>
      </div>
    </Page>
