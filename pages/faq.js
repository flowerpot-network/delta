    ...
    <Page>
      <div className="content">
        ...
        <div>
          ...
          <p className="answer">
            Yes! We will be putting lecture videos and materials on this website (on the <a href = "http://accessp2p.xyz/resources"> Resources</a> page), at the end of each week in November.
          </p><p className="question">
            Where can I stay in touch with the development of the program?
          </p>
          <p className="answer">
            Even if you can’t join us in Berlin in November, we’d love to keep you up-to-date on the program evolution, resources from our lectures, etc. The best way to do this is by <a href = "https://accessp2p.typeform.com/to/J4ahyX"> signing up</a> for our updates, keep coming back to our <a href = "http://accessp2p.xyz/resources"> Resources</a> page, or <a href = "https://twitter.com/accessp2p"> follow us</a> on Twitter.
          </p><p className="question">
