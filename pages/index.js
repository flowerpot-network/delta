  ...
  <Layout>
    ...
    <div>
      <p className="text-xl text-center text-gray-600 mb-8">
        Flowerpots link wallets to GitHub Orgs for an easier and more open way
        to sustain projects and maintainers. Flowerpots generate pretty markdown
    ...
    <div className="text-xl mt-10">
      <h1 className="text-2xl font-bold text-center mb-4">
        Claim your Flowerpot 🌻
      </h1>
      <h3 className="text-xl text-center text-gray-600 mb-8">
        Link a wallet to your GitHub Org to start collecting donations and tips!
      </h3>
      ...
      <div className="text-xl mt-8">
        <p className="mb-4">
          ...
          <code>My Account</code>) & link your GitHub account
        </p>
      </div>
      <div className="text-xl mt-8">
        <p className="mb-4">
