      ...
      <div className="content">
        ...
        <div className="resources">
          <Resource
            ...
            contact={['M: Hello@guerrillamedia.coop, Stacco@stacco.works',<br />,'T: @staccoP2P']}
            ...
            additional= {['Additional resources ',<a href= "https://drive.google.com/file/d/0B7eiTIS0EEaVcXFHN0pWZEtRQm1aOGd4eXhOUmF2V2lqVVIw/view">here</a>]}
          />
        </div>
        <div className="resources">
          <Resource
